...
## 🚨 Code qui ne respecte pas le principe d'ISP :
...
class TextDocument implements Document
{
    ...
    // 🚨 Mauvaise pratique : Méthode incohérente avec l'interface
    public function convertToPDF(): void
    {
...
class PDFDocument implements Document
{
    ...
    // 🚨 Mauvaise pratique : Méthodes incohérentes avec l'interface
    public function save(): void
    {
...
## ✅ Code qui respecte le principe d'ISP :
...
- Divisez les interfaces imoprtantes et globales en interfaces plus petites, chacune ayant à une responsabilité unique. Les classes n'implémentent que les interfaces pertinentes pour elles.
- Les interfaces doivent être créer en fonction des besoins des classes qui les implémenteront. Les interfaces ne doivent inclure que les méthodes nécessaires à ces clients (classes).
